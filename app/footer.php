				...
				<div class="row">
					...
					<fieldset class="form_tab" data-event-num="3">
						...
						<div class="col-xl-12">	
							...
							<div class="group">
								<textarea data-textarea="description" class="app_form_textarea" data-count="100" data-text="Тема обращеня (не более 100 символов)" rows="2" name="description" id="app_form_claim_29" autocomplete="off" required></textarea>
