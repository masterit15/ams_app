...
?>
        ...
        <div class="content form-control">
            ...
            <div class="col col-mb-12 col-7">
                <button class="btn" <?=(intval($arResult["F_RIGHT"]) < 10 ? "disabled=\"disabled\"" : "");?> type="submit" name="web_form_submit" value="<?=strlen(htmlspecialcharsbx(htmlspecialcharsbx(trim($arResult["arForm"]["BUTTON"])))) <= 0 ? GetMessage("FORM_ADD") : htmlspecialcharsbx($arResult["arForm"]["BUTTON"]);?>"><?=strlen(htmlspecialcharsbx(htmlspecialcharsbx(trim($arResult["arForm"]["BUTTON"])))) <= 0 ? GetMessage("FORM_ADD") : htmlspecialcharsbx($arResult["arForm"]["BUTTON"]);?></button>
            </div>
        </div>
