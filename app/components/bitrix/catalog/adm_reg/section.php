...
<table class="regl-table" cellpadding="0" cellspacing="0" height="14" width="100%">
  <tbody>
	<tr>
	  <th width="35%"><small>Наименование услуги</small></th>
	  <th><small><nobr>Исполнитель услуги</nobr> <nobr>(разработчик регламента)</nobr></small></th>
	  <th><small><nobr>Дата размещения</nobr> проекта регламента на сайте</small></th>
	  <th><small><nobr>Срок проведения</nobr> независимой экпертизы</small></th>
...
?>
<tr><th colspan="5" style="padding: 0px 0px 0px 20px;" align="center" height="9" valign="bottom"><p class="static_text"><?=$arItem['NAME'];?></p></th></tr>
<?
...
?>
<td><a href="?IBLOCK_ID=<?=$arParams['IBLOCK_ID'];?>&SECTION_ID=0&ELEMENT_ID=<?=$arFields['ID'];?>" class=\"submenu_l3\"><?=$arFields['NAME'];?></a></td>
<td><?=$arPropertyD['rmu_ispolnitel']['VALUE'];?></td>
<td><center><?=date("d.m.Y", $date_active_from_mk);?></center></td>
<td><center><?=date("d.m.Y", $date_active_from_mk);?> - <?=date("d.m.Y", dateAfterMonth
	(
	date("m", $date_active_from_mk),
	date("d", $date_active_from_mk),
	date("Y", $date_active_from_mk)
	));?></center></td>
<td><center><?=$arPropertyD['rmu_status']['VALUE_ENUM'];?></center></td>
</tr>
