	...
	<li class="folder-item js_folder-item">
		<div class="folder-item-wrap">
				<div class="folder-item__details__action">
					<div data-panel data-date="<?=$date[0].' в '.$date[1];?>" data-title="<?=$arItem["NAME"]?>" data-id="<?=$arItem["ID"]?>" data-url="/bitrix/templates/app/api/application_detail.php" class="folder-item__details__btn">Подробнее</div>
					<!-- <div class="folder-item__details__btn print_btn">Распечатать</div> -->
				</div>
		</div>
	</li>
  </ul>
