...
<head>
	...
	<meta property="og:image" content="<?= SITE_TEMPLATE_PATH ?>/path/to/image.jpg">
	...
	Bitrix\Main\Page\Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/css/main.min.css");
...
<body>
	...
	<div class="wrapper" <? if (!$GLOBALS["IS_HOME"] && !$APPLICATION->GetProperty("PJAX") == "N") { ?>id="pjax-container" <? } ?>>
	...
	false
				...
				<div class="container">
					<div class="widget_row">
						...
						<iframe id="widgetPosId" src="https://pos.gosuslugi.ru/og/widgets/view?type=[5,10,20,30,40,50,80,90,100,110]&amp;fontFamily=Arial&amp;maxPage=5&amp;maxElement=5&amp;updateFrequency=2000&amp;widgetTheme=0&amp;widgetFrameStyle=vertical&amp;level=30&amp;municipality_id=90701000&amp;startTitleColor=000000&amp;startTextColor=666666&amp;startTextBtnColor=FFFFFF&amp;startBtnBgColor=0063B0&amp;widgetBorderColor=e3e8ee&amp;widgetBorderOldPageColor=e3e8ee&amp;logoColor=ffffff&amp;phoneHeaderColor=0B40B3&amp;fillSvgHeadColor=ffffff&amp;backgroundColor=ffffff&amp;typeBgColor=F2F8FC&amp;selectColor=2c8ecc&amp;hoverSelectColor=116ca6&amp;itemColor=354052&amp;hoverItemColor=2c8ecc&amp;backgroundItemColor=f9f9fa&amp;paginationColor=000000&amp;backgroundPaginationColor=2862AC&amp;hoverPaginationColor=2862AC&amp;deviderColor=e3e8ee&amp;logoFs=16&amp;selectFs=20&amp;itemFs=14&amp;paginationFs=15&amp;widgetBorderFs=1&amp;startTitleFs=38&amp;startTextFs=18&amp;startTextBtnFs=16&amp;orgActivity=" width="100%" height="577" style="border:none"></iframe>
					</div>
					<a href="http://dom.gosuslugi.ru" target="_blank" rel="noopener noreferrer">
						<img src="<?= SITE_TEMPLATE_PATH ?>/images/jkh_banner.jpg" alt="">
					</a>
					<?if(CUser::IsAuthorized()){?>
					<a style="display: flex;justify-content: center;" href="https://www.kpmk15.ru/1100-letie-kreshhenija-alanii/" target="_blank" rel="noopener noreferrer">
						<img src="<?= SITE_TEMPLATE_PATH ?>/images/1100let_1160x120.png" alt="">
					</a>
					<?}?>
				</div>
	</div>
	...
	<section class="section count_info" style="background-image: url('<?= SITE_TEMPLATE_PATH ?>/img/count_section.jpg');">
		<div class="section_title">
			...
			<?
			$rsSections = CIBlockSection::GetList(array('id' => 'desc'),array('IBLOCK_ID' => 104));
